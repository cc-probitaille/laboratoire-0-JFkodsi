...
- <nomComplet1>Jean-François Kodsi</nomComplet1>
- <courriel1>jean-francois.kodsi.1@ens.etsmtl.ca</courriel1>
- <codeMoodle1>LOG210-02</codeMoodle1>
- <githubAccount1>JFkodsi</githubAccount1>
...
## Diagramme de classe logicielle 
